...
**Date**: January 2026
**Reference Implementation**: jrouter at `/Users/blake/code/jrouter` (Go)
...
### jrouter Architecture (Reference)

jrouter is a Go implementation of an AppleTalk router with AURP support:
- **Location**: `/Users/blake/code/jrouter/`
- **Size**: ~8,000+ lines of Go code
- **Key Packages**:
  - `aurp/` - AURP packet encoding/decoding
  - `router/` - Core routing logic, peer management
  - `atalk/` - Protocol handlers (RTMP, ZIP, NBP)
...
5. Test: Verify packets from jrouter are received and parsed
...
6. Test: Verify connection establishment with jrouter
...
6. Test: Verify routes are learned from jrouter
...
4. Test: Verify zones are learned from jrouter
...
1. Test interoperability with jrouter across various scenarios
2. Test multi-peer configurations
3. Test failure and recovery scenarios
4. Add comprehensive error handling
5. Write documentation and man page updates
...
### Integration Tests
- Connection establishment with jrouter
...
- jrouter peer (primary test target)
...
- jrouter source code: https://github.com/sfiera/jrouter (or local copy)
...
2. [ ] Ensure jrouter reference is available at `/Users/blake/code/jrouter`
...
5. [ ] Use jrouter as reference for packet formats and state machine logic
6. [ ] Test each phase against jrouter before proceeding to next
